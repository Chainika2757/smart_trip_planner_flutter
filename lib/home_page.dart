  ...
  void _sendVision() async {
    ...
    if (visionText.isNotEmpty) {
      ...
      try {
        ...
        setState(() {
          _errorMessage =
              'Failed to generate itinerary. Please try again. Error: ${e.toString()}';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        leading:
            const Icon(Icons.airplanemode_active_rounded, color: Colors.amber),
        title: const Text(
          'Itinera AI',
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  const Color.fromARGB(255, 2, 110, 61),
